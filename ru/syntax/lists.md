...
Для создания вложенного списка добавьте отступ перед элементами дочернего списка. Рекомендуемый размер отступа — четыре пробела.

[//]: # (ни два, ни три пробела не работают, предлагаю убрать их упоминание. Кроме того, прошу уточнить описание синтакиса для комментариев. Там все символы тобязательны? И хештег, и скобки?)
